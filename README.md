...
[`makerestriction.R`](https://github.com/takaoksuzuki/pathwayPCM/blob/main/src/R/makerestriction.R)
 generates intermediate restriction files (mycommand_*.txt) for Step 2. Output files are saved in the [`results/`](https://github.com/takaoksuzuki/pathwayPCM/blob/main/results) directory.
